...
trait FixturesTrait {
  ...
  protected static function fixturesCreateReadme(string $dir) {
    return static::vfsCreateFile($dir . DIRECTORY_SEPARATOR . 'README.md', 'badge/DrevOps-');
  }
  ...
  protected static function fixturesCreateComposerjson(string $dir, $values) {
    ...
    return static::vfsCreateFile($dir . '/composer.json', $json);
  }
