...
class Config extends AbstractBag {
  ...
  public function __construct() {
    ...
    $this->collectFromEnv([
      ...
      // Flag to proceed with installation. If FALSE - the installation will
      // only print resolved values and will not proceed.
      Env::INSTALLER_INSTALL_PROCEED => TRUE,
      // Temporary directory to download and expand files to.
      Env::INSTALLER_TMP_DIR => Files::tempdir(),
      // Path to local DrevOps repository. If not provided - remote will be
      // used.
      Env::INSTALLER_LOCAL_REPO => NULL,
      // Optional commit to download. If not provided, the latest release will
      // be downloaded.
